...
console.log("welcome login controller");
angular.module("nautilus",[])
.controller("LoginController",['$scope','$http','$window', function($scope,$http,$window){
  ...
  $scope.loginCall = function(){
    ...
    //var username = $scope.user.username;
    //var password = $scope.user.password;
    $http.post('/api/user/login', $scope.data, config).success(function(response){
      ...
      console.log("error login");
      //console.data(data);
      //var alertPopub = $ionicPopup.alert({
        //title: 'login failed',
        //template: 'user/password  is worn'
      //});
    });
  }
}])
...
console.log("before function");
    $scope.loginCall= function(){
      console.log("logincall function");
      console.log($scope.data);
      $http.post('/api/user/login', $scope.data, config).then($scope.successCallback, $scope.errorCallback);
    }
